...
If the camera you are using is not in this supported list, you can use the repository under the [main branch](https://github.com/orbbec/OrbbecSDK_ROS2/tree/main) to use your camera
