...
def generate_launch_description():
    args = [
        ...
        DeclareLaunchArgument('laser_index1_laser_control', default_value='1'),#interleave_laser_param
        ...
        DeclareLaunchArgument('laser_index1_ir_ae_max_exposure', default_value='10000'),
        DeclareLaunchArgument('laser_index0_laser_control', default_value='0'),
        ...
        DeclareLaunchArgument('laser_index0_ir_ae_max_exposure', default_value='7500'),
