...
def generate_launch_description():
    args = [
        ...
        DeclareLaunchArgument(
            "enable_color_auto_exposure_priority", default_value="false"
        ),
        DeclareLaunchArgument(
            "color_rotation", default_value="-1"
        ...
        DeclareLaunchArgument(
            "enable_color_backlight_compenstation", default_value="false"
        ),
        DeclareLaunchArgument(
            "color_powerline_freq", default_value=""
        ...
        DeclareLaunchArgument(
            "enable_depth_auto_exposure_priority", default_value="false"
        ),
        DeclareLaunchArgument("depth_precision", default_value=""),
        DeclareLaunchArgument(
            "depth_rotation", default_value="-1"
        ...
        DeclareLaunchArgument(
            "left_ir_rotation", default_value="-1"
        ),  # left_ir rotation degree : 0, 90, 180, 270
        DeclareLaunchArgument("left_ir_flip", default_value="false"),
        DeclareLaunchArgument("left_ir_mirror", default_value="false"),
        DeclareLaunchArgument(
            "enable_left_ir_sequence_id_filter", default_value="false"
        ),
        ...
        DeclareLaunchArgument(
            "right_ir_rotation", default_value="-1"
        ),  # right_ir rotation degree : 0, 90, 180, 270
        DeclareLaunchArgument("right_ir_flip", default_value="false"),
        DeclareLaunchArgument("right_ir_mirror", default_value="false"),
        DeclareLaunchArgument(
            "enable_right_ir_sequence_id_filter", default_value="false"
        ),
        ...
        DeclareLaunchArgument(
            "exposure_range_mode", default_value="default"
        ),  # default, ultimate or regular
        DeclareLaunchArgument("log_level", default_value="none"),
        DeclareLaunchArgument("enable_publish_extrinsic", default_value="false"),
        DeclareLaunchArgument("enable_d2c_viewer", default_value="false"),
        DeclareLaunchArgument("disaparity_to_depth_mode", default_value="true"),
        ...
        DeclareLaunchArgument(
            "enable_ptp_config", default_value="false"
        ...
        DeclareLaunchArgument(
            "hardware_noise_removal_filter_threshold", default_value="-1.0"
        ),
        ...
        DeclareLaunchArgument(
            "align_target_stream", default_value="COLOR"
        ),  # COLOR or DEPTH
        ...
        DeclareLaunchArgument(
            "time_domain", default_value="global"
        ...
        DeclareLaunchArgument(
            "frame_aggregate_mode", default_value="ANY"
        ),  # full_frame、color_frame、ANY or disable
        DeclareLaunchArgument(
            "interleave_ae_mode", default_value="laser"
        ),  # 'hdr' or 'laser'
        ...
        DeclareLaunchArgument(
            "interleave_skip_index", default_value="1"
        ),  # 0:skip pattern ir  1: skip flood ir
        DeclareLaunchArgument(
            "hdr_index1_laser_control", default_value="1"
        ...
        DeclareLaunchArgument(
            "laser_index1_laser_control", default_value="0"
