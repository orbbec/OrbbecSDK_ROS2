...
1. **Basic Depth to Color Alignment:**
   ...
   ```bash
   ros2 launch orbbec_camera gemini_generic.launch.py depth_registration:=true
   ```
...
2. **Viewing Depth to Color Overlay:**
   ...
   ```bash
   ros2 launch orbbec_camera gemini_generic.launch.py depth_registration:=true enable_d2c_viewer:=true
   ```
