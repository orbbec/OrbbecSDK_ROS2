...
def generate_launch_description():
    args = [
        ...
        DeclareLaunchArgument(
            "attach_component_container_enable", default_value="false"
        ),
        DeclareLaunchArgument(
            "attach_component_container_name", default_value="orbbec_container"
        ),
    ]
    ...
    def create_node_action(context, args):
        ...
        if ros_distro == "foxy":
            ...
            component_container_name_arg = LaunchConfiguration(
                "component_container_name", default="orbbec_container"
            )
