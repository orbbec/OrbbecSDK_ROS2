...
---
OrbbecSDK ROS2 is a wrapper for the Orbbec 3D camera, providing seamless integration with the ROS2 environment.
...
- `connection_delay`: The delay time in seconds for reopening the device.
